...
BEGIN
    ...
    IF p_github_user IS NULL OR TRIM(p_github_user) = '' THEN
        RAISE EXCEPTION 'Se requiere el nombre de usuario de GitHub.';
    END IF;
    ...
    VALUES (
        ...
        p_cv_url,
        p_genero_id,
        COALESCE(p_vegano, FALSE), -- Default false
...
CALL extensions.sp_registro_participantes(
    ...
    'https://github.com/BlueE-05',         -- p_github_user
    'https://github.com/BlueE-05',         -- p_cv_url
    1,                                     -- p_genero_id
    FALSE,                                 -- p_vegano
